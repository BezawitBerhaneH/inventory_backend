...
describe("system admin Controller", function () {
  ...
  describe("GET /allroles", function () {
    ...
    it("should return 403 if the user is not a  system admin", function (done) {
      const req = {
        user: { role: "department" }, // Mock authenticated user with role 'department'
      };
      const res = {
  ...
  describe("GET /allsupplier", function () {
    it("should return all suppliers in the system", function (done) {
      const req = {
    ...
    it("should return 403 if the user is not  the system admin", function (done) {
      const req = {
  ...
  describe("POST /creatadminuser", function () {
    it("should create a new users  accountwith users of specific role", function (done) {
      const req = {
        body: {
          itemDetails: "Item 1",
          quantity: 10,
    ...
    it("should return 403 if the user is not system admin ", function (done) {
      const req = {
        body: {
          itemDetails: "Item 1",
          quantity: 10,
    ...
    it("should return 400 if  details  is missing", function (done) {
      const req = {
        body: {},
  ...
  describe("patch /deactivate", function () {
  ...
  describe("put /updateuser", function () {
    it("should update user information user", function (done) {
      const req = {
        body: {
          requestID: 1,
        },
